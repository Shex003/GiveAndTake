...
ActiveRecord::Schema[7.1].define(version: 2024_05_30_131323) do
  ...
  create_table "trades", force: :cascade do |t|
    ...
    t.index ["offered_item_id"], name: "index_trades_on_offered_item_id"
    t.index ["receiver_id"], name: "index_trades_on_receiver_id"
    t.index ["requested_item_id"], name: "index_trades_on_requested_item_id"
  end
